...
func (ms memSegment64) contain(addr uint64) bool{
	return ms.begin <= addr && addr < ms.end()
}

func (ms memSegment64) overlay(other *memSegment64) bool{
...
func (m *Memory64) findSeg(addr uint64) (*memSegment64, bool) {
